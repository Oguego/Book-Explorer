...
ActiveRecord::Schema.define(version: 20201110232841) do
  ...
  create_table "csv_files", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "file"
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.string   "file_name"
    t.string   "file_url",   limit: 755
    t.string   "name"
    t.integer  "user_id"
